...
> **O Priceless Bank não está perdendo clientes. Ele nunca foi o banco principal deles — e agora parou
> de conquistar novos.**
...
| O produto cartão decepcionou | A frequência de uso cai **48,1%** (13,6 → 7,1 tx/cliente/trimestre) |
| O dinheiro está fugindo | A captação líquida segue **positiva em todos os 12 trimestres** |

**A conta fecha assim:** a queda de share é quase toda **share-of-wallet**, não churn. E a origem disso
...
As três frentes abaixo estão nessa ordem de causalidade — mas a execução é paralela, porque a Frente 3
paga o custo das outras duas em 90 dias.

---

## 4. As três frentes de ação

### Frente 1 · Conquistar a principalidade — *a raiz*

**Insight que sustenta (H1 · confirmada).** Procuramos o salário na base e ele não está lá. Apenas
**4,3% dos clientes** (62 de 1.427) recebem PIX de PJ com regularidade mensal, e o recebimento mediano
de PJ é de **R$ 160** — não é salário de ninguém. Para cada R$ 1,00 que entra por PIX, saem **R$ 7,36**.
E **os 1.430 clientes que usam PIX têm fluxo líquido negativo, sem uma única exceção.**
...
**Meta.** Clientes com crédito recorrente mensal: **4,3% → 25% em 12 meses**.
Razão saída/entrada por PIX: **7,36× → 4,0×**.

**Por que funciona.** Papaya (42,7% de principalidade) e LuminaPay (37,4%) lideram exatamente essa métrica
no benchmarking. Principalidade é o que sustenta share, não campanha de transação.

---

### Frente 2 · Reabrir o funil de entrada — *a urgência*

**Insight que sustenta (H3 · refutada, e a refutação vale mais).** A hipótese era que o cliente parou de
...
nenhum**. A emissão não secou por falta de demanda — secou porque a **aquisição** secou.

**Ação proposta**

| # | O que fazer | Detalhe |
|---|---|---|
| 2.1 | **Destravar a emissão de cartão — imediato** | Zero cartões em 7 meses é anomalia operacional ou decisão de política de crédito. Descobrir qual em 30 dias |
...
| 2.3 | **Ativação assistida em 30 dias** | Hoje a mediana é de **34 dias** e o percentil 75 é de **209 dias**. Um em cada quatro cartões passa 7 meses parado |
...
### Frente 3 · Destravar o investimento — *o quick win*

**Insight que sustenta (H8 · confirmada, com as duas explicações rivais descartadas).** Os **255
clientes sem renda cadastrada** usam cartão (73,3%) e PIX (74,1%) exatamente como os demais — não são
clientes inativos. Mas apenas **5,5% deles investem**, contra **58,0%** de quem tem renda preenchida.
**Onze vezes menos.**
...
**Meta.** Cadastro completo: **87,0% → 97%** em 90 dias.
...
### Frente 4 · Higiene competitiva — *necessária, mas não é a alavanca*

**Insight que sustenta (H6 · parcialmente confirmada).** O PIX é reprovado em **10,07%** das tentativas
...
**Mas atenção — e esta ressalva muda a prioridade:** a taxa é **estável desde 2023** (9,7% a 10,4%), e
os clientes no quartil de **maior** reprovação reduziram o uso do cartão na **mesma proporção** dos de
menor reprovação (correlação −0,01). Um problema constante não explica uma mudança.

**Conclusão.** Consertar o PIX **não trará os clientes de volta sozinho**. É higiene competitiva contra
...
**Meta.** Reprovação de PIX: **10,07% → <2%**.

---

### Frente 5 · Governança de dados — *o habilitador*

Nada acima é gerenciável sem isto. A base entregue tem:
...
**Ação.** Instituir contrato de dados com checagens automáticas de consistência temporal, chave primária
...
**Leitura da matriz.** As duas primeiras são alto retorno e baixo esforço — devem começar esta semana. A
Frente 1 é a que resolve a raiz, mas é a mais cara e a mais lenta: começar já, sem esperar resultado das
outras.
...
**Métrica-mãe:** transações por cliente ativo por trimestre — hoje **7,1**, teto histórico **13,7**
...
Quatro caminhos que a análise eliminou. Não persegui-los é parte da recomendação — cada um custaria
orçamento e tempo sem retorno.

| ❌ Não faça | Por quê |
|---|---|
| **Campanha de retenção anti-churn** | Não há churn a reter. Só 27 clientes sumiram entre os semestres de 2025 e a recência mediana é de 12 dias. O cliente está lá — ele só não usa |
| **Redesenhar o produto cartão para reconquistar a base** | A safra de 2023 não se decepcionou: fez 47,7 transações no primeiro ano e 77% dela segue ativa. O cartão parou de ser emitido porque a conta parou de ser aberta |
| **Tratar como fuga de investimento** | A captação líquida foi **positiva nos 12 trimestres**. Não há fuga — há desaceleração. A resposta é acelerar captação, não conter saída |
| **Priorizar o PIX como alavanca de recuperação** | A taxa de reprovação é estável desde 2023 e não tem efeito mensurável sobre o uso (correlação −0,01). Consertar é necessário; não é o que reverte o share |

E uma restrição analítica: **não usar ticket médio, "cliente de alto valor" ou segmentação por valor de
compra.** O campo `Valor_Compra` segue distribuição uniforme entre R$ 0 e R$ 1.200 — foi sorteado, não
observado. Qualquer métrica construída sobre ele é ruído.

---

## 9. O que precisamos do banco antes de executar

| Pergunta | Por que importa | Bloqueia |
|---|---|---|
| Por que a emissão de cartão está em **zero desde junho de 2025**? | Se foi decisão deliberada de política de crédito, muda metade do diagnóstico | Frente 2 |
| O que mudou na extração de dados em **agosto de 2025**? | Duas bases independentes mudam de patamar no mesmo dia. Afeta a confiança em H2, H5, H7 e no degrau de resgates | Frentes 1 e 3 |
| Os **7 meses ausentes** de PIX (jan–jul/2025) existem em algum lugar? | Sem eles não dá para afirmar tendência de PIX em 2025 | Frente 1 |
| Como é o **funil de cadastro**? Onde o cliente abandona? | A hipótese de atrito no onboarding é plausível mas não testável com a base atual | Frente 3 |
| O salário chega por outro canal (TED, folha)? | Toda a leitura de principalidade depende de o PIX ser representativo das entradas | Frente 1 |
...
**O diferencial da análise.** Quatro das nove hipóteses iniciais **não sobreviveram ao teste** — e duas
refutações mudaram o alvo da recomendação. O trabalho não foi confirmar o que se suspeitava; foi
descobrir onde a suspeita estava errada.
